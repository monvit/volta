...
ConnectReactor::ConnectReactor(IMessageHandler* handler, ::volta::VoltaCollector::Stub* stub)
  : handler_(handler) {
...
::volta::ControlMessage ConnectReactor::CreateMessage(::volta::MessageType type, const std::string& error) {
